...
import com.noxclient.events.render.RenderAfterWorldEvent;
import com.noxclient.mixininterface.IVec3d;
import com.noxclient.renderer.Renderer3D;
import com.noxclient.systems.modules.Modules;
import com.noxclient.systems.modules.player.LiquidInteract;
import com.noxclient.systems.modules.player.NoMiningTrace;
...
import com.noxclient.systems.modules.render.Zoom;
...
public abstract class GameRendererMixin {
    ...
    private void onRenderWorld(float tickDelta, long limitTime, MatrixStack matrices, CallbackInfo info, boolean bl, Camera camera, MatrixStack matrixStack, double d, float f, float g, Matrix4f matrix4f, Matrix3f matrix3f) {
        ...
        client.getProfiler().push(NoxClient.MOD_ID + "_render");
    ...
    private void onRenderWorldTail(CallbackInfo info) {
        NoxClient.EVENT_BUS.post(RenderAfterWorldEvent.get());
    }
