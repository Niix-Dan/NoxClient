...
public class ColorSettingScreen extends WindowScreen {
    ...
    public boolean toClipboard() {
        ...
        NoxClient.mc.keyboard.setClipboard(color);
        return NoxClient.mc.keyboard.getClipboard().equals(color);
    }

    @Override
    public boolean fromClipboard() {
        String clipboard = NoxClient.mc.keyboard.getClipboard().trim();
        SettingColor parsed;
    ...
    public void initWidgets() {
        ...
        rainbowList.add(theme.label("nox: "));
