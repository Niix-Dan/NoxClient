...
import com.noxclient.gui.tabs.screens.settings.*;
import com.noxclient.gui.utils.Cell;
import com.noxclient.gui.utils.CharFilter;
import com.noxclient.gui.utils.SettingsWidgetFactory;
import com.noxclient.gui.widgets.*;
import com.noxclient.gui.widgets.containers.*;
import com.noxclient.gui.widgets.input.*;
...
public class DefaultSettingsWidgetFactory implements SettingsWidgetFactory {
    ...
    private void genericW(WTable table, GenericSetting<?> setting) {
        ...
        edit.action = () -> NoxClient.mc.setScreen(setting.get().createScreen(theme));
    ...
    private void colorW(WTable table, ColorSetting setting) {
        ...
        edit.action = () -> NoxClient.mc.setScreen(new ColorSettingScreen(theme, setting));
    ...
    private void blockListW(WTable table, BlockListSetting setting) {
        selectW(table, setting, () -> NoxClient.mc.setScreen(new BlockListSettingScreen(theme, setting)));
    }
    ...
    private void itemListW(WTable table, ItemListSetting setting) {
        selectW(table, setting, () -> NoxClient.mc.setScreen(new ItemListSettingScreen(theme, setting)));
    }

    private void entityTypeListW(WTable table, EntityTypeListSetting setting) {
        selectW(table, setting, () -> NoxClient.mc.setScreen(new EntityTypeListSettingScreen(theme, setting)));
    }

    private void enchantmentListW(WTable table, EnchantmentListSetting setting) {
        selectW(table, setting, () -> NoxClient.mc.setScreen(new EnchantmentListSettingScreen(theme, setting)));
    }

    private void moduleListW(WTable table, ModuleListSetting setting) {
        selectW(table, setting, () -> NoxClient.mc.setScreen(new ModuleListSettingScreen(theme, setting)));
    }

    private void packetListW(WTable table, PacketListSetting setting) {
        selectW(table, setting, () -> NoxClient.mc.setScreen(new PacketBoolSettingScreen(theme, setting)));
    }

    private void particleTypeListW(WTable table, ParticleTypeListSetting setting) {
        selectW(table, setting, () -> NoxClient.mc.setScreen(new ParticleTypeListSettingScreen(theme, setting)));
    }

    private void soundEventListW(WTable table, SoundEventListSetting setting) {
        selectW(table, setting, () -> NoxClient.mc.setScreen(new SoundEventListSettingScreen(theme, setting)));
    }

    private void statusEffectAmplifierMapW(WTable table, StatusEffectAmplifierMapSetting setting) {
        selectW(table, setting, () -> NoxClient.mc.setScreen(new StatusEffectAmplifierMapSettingScreen(theme, setting)));
    }

    private void statusEffectListW(WTable table, StatusEffectListSetting setting) {
        selectW(table, setting, () -> NoxClient.mc.setScreen(new StatusEffectListSettingScreen(theme, setting)));
    }

    private void storageBlockListW(WTable table, StorageBlockListSetting setting) {
        selectW(table, setting, () -> NoxClient.mc.setScreen(new StorageBlockListSettingScreen(theme, setting)));
    }
    ...
    private void blockDataW(WTable table, BlockDataSetting<?> setting) {
        ...
        button.action = () -> NoxClient.mc.setScreen(new BlockDataSettingScreen(theme, setting));
    ...
    private void colorListWFill(WTable t, ColorListSetting setting) {
        ...
        for (SettingColor color : setting.get()) {
            ...
            edit.action = () -> {
                ...
                NoxClient.mc.setScreen(new ColorSettingScreen(theme, set));
            };
