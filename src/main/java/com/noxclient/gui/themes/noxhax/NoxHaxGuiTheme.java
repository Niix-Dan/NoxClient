...
import com.noxclient.gui.themes.noxhax.widgets.*;
import com.noxclient.gui.themes.noxhax.widgets.input.WMeteorDropdown;
import com.noxclient.gui.themes.noxhax.widgets.input.WMeteorSlider;
import com.noxclient.gui.themes.noxhax.widgets.input.WMeteorTextBox;
import com.noxclient.gui.themes.noxhax.widgets.pressable.*;
import com.noxclient.gui.widgets.*;
...
import com.noxclient.gui.widgets.pressable.*;
import com.noxclient.NoxClient;
import com.noxclient.gui.DefaultSettingsWidgetFactory;
import com.noxclient.gui.GuiTheme;
import com.noxclient.gui.WidgetScreen;

import com.noxclient.gui.utils.AlignmentX;
import com.noxclient.gui.utils.CharFilter;
...
public class NoxHaxGuiTheme extends GuiTheme {
    ...
    public final Setting<Double> scale = sgGeneral.add(new DoubleSetting.Builder()
        ...
        .onSliderRelease()
        .onChanged(aDouble -> {
            if (NoxClient.mc.currentScreen instanceof WidgetScreen) ((WidgetScreen) NoxClient.mc.currentScreen).invalidate();
        })
        .build()
    );
    ...
    public final Setting<Boolean> hideHUD = sgGeneral.add(new BoolSetting.Builder()
        ...
        .defaultValue(false)
        .onChanged(v -> {
            if (NoxClient.mc.currentScreen instanceof WidgetScreen) NoxClient.mc.options.hudHidden = v;
        })
        .build()
    );
    ...
    public final Setting<SettingColor> accentColor = color("accent", "Main color of the GUI.", new SettingColor(54, 57, 63));
    public final Setting<SettingColor> checkboxColor = color("checkbox", "Color of checkbox.", new SettingColor(255, 255, 255));
    public final Setting<SettingColor> plusColor = color("plus", "Color of plus button.", new SettingColor(206, 206, 206));
    public final Setting<SettingColor> minusColor = color("minus", "Color of minus button.", new SettingColor(206, 206, 206));
    public final Setting<SettingColor> favoriteColor = color("favorite", "Color of checked favorite button.", new SettingColor(71, 193, 193));

    // Text

    public final Setting<SettingColor> textColor = color(sgTextColors, "text", "Color of text.", new SettingColor(210, 216, 217));
    public final Setting<SettingColor> textSecondaryColor = color(sgTextColors, "text-secondary-text", "Color of secondary text.", new SettingColor(210, 208, 176));
    public final Setting<SettingColor> textHighlightColor = color(sgTextColors, "text-highlight", "Color of text highlighting.", new SettingColor(240, 238, 211));
    ...
    public final Setting<SettingColor> loggedInColor = color(sgTextColors, "logged-in-text", "Color of logged in account name.", new SettingColor(220, 214, 207));
    ...
    public final ThreeStateColorSetting backgroundColor = new ThreeStateColorSetting(
        sgBackgroundColors,
        "background",
        new SettingColor(26, 27, 30, 200),
        new SettingColor(26, 27, 30, 200),
        new SettingColor(26, 27, 30, 200)
    );

    public final Setting<SettingColor> moduleBackground = color(sgBackgroundColors, "module-background", "Color of module background when active.", new SettingColor(39, 41, 45));
    ...
    public final ThreeStateColorSetting sliderHandle = new ThreeStateColorSetting(
        sgSlider,
        "slider-handle",
        new SettingColor(238, 228, 251),
        new SettingColor(248, 238, 251),
        new SettingColor(255, 255, 255)
    );

    public final Setting<SettingColor> sliderLeft = color(sgSlider, "slider-left", "Color of slider left part.", new SettingColor(238, 228, 251));
    public final Setting<SettingColor> sliderRight = color(sgSlider, "slider-right", "Color of slider right part.", new SettingColor(51, 50, 51));
