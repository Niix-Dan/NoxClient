...
import com.noxclient.utils.misc.CursorStyle;
...
import static com.noxclient.utils.Utils.getWindowHeight;
import static com.noxclient.utils.Utils.getWindowWidth;
...
public abstract class WidgetScreen extends Screen {
    ...
    public WidgetScreen(GuiTheme theme, String title) {
        ...
        this.parent = NoxClient.mc.currentScreen;
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        double s = NoxClient.mc.getWindow().getScaleFactor();
        mouseX *= s;
        mouseY *= s;
    ...
    private static class WFullScreenRoot extends WContainer implements WRoot {
        ...
        public boolean render(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            if (!valid) {
                ...
                valid = true;
                mouseMoved(NoxClient.mc.mouse.getX(), NoxClient.mc.mouse.getY(), NoxClient.mc.mouse.getX(), NoxClient.mc.mouse.getY());
            }
