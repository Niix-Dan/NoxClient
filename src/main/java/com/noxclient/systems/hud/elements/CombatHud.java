    ...
    public void render(HudRenderer renderer) {
        renderer.post(() -> {
            ...
            InventoryScreen.drawEntity(
                ...
                (int) (y + (66 * scale.get())),
                (int) (30 * scale.get()),
                -MathHelper.wrapDegrees(playerEntity.prevYaw + (playerEntity.getYaw() - playerEntity.prevYaw) * NoxClient.mc.getTickDelta()),
            ...
            // Distance
            double dist = 0;
            if (!isInEditor()) dist = Math.round(NoxClient.mc.player.distanceTo(playerEntity) * 100.0) / 100.0;
