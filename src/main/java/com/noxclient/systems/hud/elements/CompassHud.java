...
public class CompassHud extends HudElement {
    ...
    public void render(HudRenderer renderer) {
        ...
        double pitch = isInEditor() ? 120 : MathHelper.clamp(NoxClient.mc.player.getPitch() + 30, -90, 90);
        pitch = Math.toRadians(pitch);

        double yaw = isInEditor() ? 180 : MathHelper.wrapDegrees(NoxClient.mc.player.getYaw());
