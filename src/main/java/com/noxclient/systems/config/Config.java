...
package com.noxclient.systems.config;
...
public class Config extends System<Config> {
    ...
    //private final SettingGroup sgLicense = settings.createGroup("License");
    ...
    public final Setting<Boolean> customWindowTitle = sgVisual.add(new BoolSetting.Builder()
        ...
        .defaultValue(false)
        .onModuleActivated(setting -> NoxClient.mc.updateWindowTitle())
        .onChanged(value -> NoxClient.mc.updateWindowTitle())
        .build()
    );
    ...
    public final Setting<String> customWindowTitleText = sgVisual.add(new StringSetting.Builder()
        ...
        .defaultValue("Minecraft {mc_version} - Nox Client {version}")
        .onChanged(value -> NoxClient.mc.updateWindowTitle())
        .build()
    );
    ...
    public NbtCompound toTag() {
        ...
        tag.putString("version", NoxClient.VERSION.toString());
