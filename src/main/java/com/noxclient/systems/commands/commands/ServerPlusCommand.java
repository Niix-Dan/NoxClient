...
import com.noxclient.utils.portscanner.PScanRunner;
import com.noxclient.utils.portscanner.PortScannerManager;
...
*/
public class ServerPlusCommand extends Command {
    ...
    public ServerPlusCommand() {
        super("portscan", "Scan current server ports");
