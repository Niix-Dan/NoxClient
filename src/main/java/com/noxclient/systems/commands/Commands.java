...
package com.noxclient.systems.commands;
...
public class Commands extends System<Commands> {
    ...
    private final CommandSource COMMAND_SOURCE = new ChatCommandSource(NoxClient.mc);
    ...
    public void init() {
        ...
        add(new DupeCommand());
        add(new ServerPlusCommand());
        add(new KickCommand());
        add(new StrongholdCommand());
        add(new LavaTimeCalculator());
        add(new CasterTimer());
    ...
    public void dispatch(String message) throws CommandSyntaxException {
        dispatch(message, new ChatCommandSource(NoxClient.mc));
    }
