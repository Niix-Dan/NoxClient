...
public class NoSlow extends Module {
    ...
    public boolean berryBush() { return isActive() && berryBush.get(); }
    public boolean slowness() { return isActive() && slowness.get(); }
    public boolean cobweb() { return isActive() && web.get() == WebMode.Vanilla; }
