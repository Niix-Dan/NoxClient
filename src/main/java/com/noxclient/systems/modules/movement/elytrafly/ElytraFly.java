...
package com.noxclient.systems.modules.movement.elytrafly;

import com.noxclient.NoxClient;
import com.noxclient.mixininterface.IVec3d;
import com.noxclient.settings.*;
import com.noxclient.systems.modules.movement.elytrafly.modes.Packet;
import com.noxclient.systems.modules.movement.elytrafly.modes.Pitch40;
import com.noxclient.systems.modules.movement.elytrafly.modes.Vanilla;
...
import com.noxclient.systems.modules.player.ChestSwap;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        NoxClient.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        NoxClient.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        NoxClient.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        NoxClient.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
