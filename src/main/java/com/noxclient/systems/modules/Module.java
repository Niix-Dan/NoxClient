...
public abstract class Module implements ISerializable<Module>, Comparable<Module> {
    ...
    public Module(Category category, String name, String description) {
        ...
        this.description = description;//Config.get().translate(description);
    ...
    public void emitToggle(Module module) {}
    ...
    public void toggle(boolean status) {
        ...
        if (status) {
            ...
            if (runInMainMenu || Utils.canUpdate()) {
                if (autoSubscribe) NoxClient.EVENT_BUS.subscribe(this);
                onActivate();
            }
        }
        else {
            if (runInMainMenu || Utils.canUpdate()) {
                if (autoSubscribe) NoxClient.EVENT_BUS.unsubscribe(this);
                onDeactivate();
            }
