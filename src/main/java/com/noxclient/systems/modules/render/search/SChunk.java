...
import static com.noxclient.utils.Utils.getRenderDistance;
...
public class SChunk {
    ...
    public boolean shouldBeDeleted() {
        ...
        int chunkX = ChunkSectionPos.getSectionCoord(NoxClient.mc.player.getBlockPos().getX());
        int chunkZ = ChunkSectionPos.getSectionCoord(NoxClient.mc.player.getBlockPos().getZ());
    ...
    public static SChunk searchChunk(Chunk chunk, List<Block> blocks) {
        ...
        for (int x = chunk.getPos().getStartX(); x <= chunk.getPos().getEndX(); x++) {
            for (int z = chunk.getPos().getStartZ(); z <= chunk.getPos().getEndZ(); z++) {
                ...
                for (int y = NoxClient.mc.world.getBottomY(); y < height; y++) {
                    blockPos.set(x, y, z);
