...
import com.noxclient.utils.Constants;
import com.noxclient.utils.misc.MeteorStarscript;
import com.noxclient.utils.misc.StarscriptUtils;
...
public class Announcer extends Module {
    ...
    public void onActivate() {
        for (Feature feature : features) {
            if (feature.isEnabled()) {
                ...
                NoxClient.EVENT_BUS.subscribe(feature);
                feature.reset();
            }
        }
    }
    ...
    public void onDeactivate() {
        for (Feature feature : features) {
            if (feature.isEnabled()) {
                NoxClient.EVENT_BUS.unsubscribe(feature);
            }
        }
    }
