...
import com.noxclient.utils.render.MeteorToast;
...
public class StashFinder extends Module {
    ...
    public StashFinder() {
        super(Categories.World, "stash-finder", "Searches loaded chunks for storage blocks. Saves to <your minecraft folder>/nox-client");
    }
    ...
    private File getJsonFile() {
        return new File(new File(new File(NoxClient.FOLDER, "stashes"), Utils.getWorldName()), "stashes.json");
    }

    private File getCsvFile() {
        return new File(new File(new File(NoxClient.FOLDER, "stashes"), Utils.getWorldName()), "stashes.csv");
    }
