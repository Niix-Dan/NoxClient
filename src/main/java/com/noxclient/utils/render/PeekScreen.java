...
public class PeekScreen extends ShulkerBoxScreen {
    ...
    public PeekScreen(ItemStack storageBlock, ItemStack[] contents) {
        super(new ShulkerBoxScreenHandler(0, NoxClient.mc.player.getInventory(), new SimpleInventory(contents)), NoxClient.mc.player.getInventory(), storageBlock.getName());
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (button == GLFW.GLFW_MOUSE_BUTTON_MIDDLE && focusedSlot != null && !focusedSlot.getStack().isEmpty() && NoxClient.mc.player.currentScreenHandler.getCursorStack().isEmpty() && toolips.middleClickOpen()) {
