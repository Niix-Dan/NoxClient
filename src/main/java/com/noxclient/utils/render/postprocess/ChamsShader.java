...
public class ChamsShader extends EntityShader {
    ...
    public ChamsShader() {
        NoxClient.EVENT_BUS.subscribe(ChamsShader.class);
    }
    ...
    public static void load() {
        try {
            ...
            for (String fileFormat : FILE_FORMATS) {
                Optional<Resource> optional = NoxClient.mc.getResourceManager().getResource(new MeteorIdentifier("textures/chams." + fileFormat));
    ...
    public boolean shouldDraw(Entity entity) {
        ...
        return chams.entities.get().getBoolean(entity.getType()) && (entity != NoxClient.mc.player || !chams.ignoreSelfDepth.get());
    }
}
