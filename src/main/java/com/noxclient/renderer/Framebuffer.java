...
public class Framebuffer {
    ...
    private void init() {
        ...
        GL.textureImage2D(GL_TEXTURE_2D, 0, GL_RGB, NoxClient.mc.getWindow().getFramebufferWidth(), NoxClient.mc.getWindow().getFramebufferHeight(), 0, GL_RGB, GL_UNSIGNED_BYTE, null);
